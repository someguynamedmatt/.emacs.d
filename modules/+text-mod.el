...
POS defaults to the current position."
  (let ((pos (or pos (point))))
    (or (run-hook-with-args-until-success 'my-point-in-comment-functions pos)
...
(defun my-point-in-string-p (&optional pos)
  ...
  (let ((pos (or pos (point))))
    (or (run-hook-with-args-until-success 'my-point-in-string-functions pos)
